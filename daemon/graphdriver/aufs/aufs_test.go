...
func TestHardlinks(t *testing.T) {
	...
	if err := d.Create("source-1", "", "", nil); err != nil {
		t.Fatal(err)
	}
	...
	if err := d.Create("source-2", "source-1", "", nil); err != nil {
		t.Fatal(err)
	}
	...
	if err := d.Create("target-1", "", "", nil); err != nil {
		t.Fatal(err)
	}
	...
	if err := d.Create("target-2", "target-1", "", nil); err != nil {
		t.Fatal(err)
	}
